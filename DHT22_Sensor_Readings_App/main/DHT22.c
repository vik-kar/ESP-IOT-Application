...
/* The DHT22 sensor task will run this task when it is created */
static void DHT22_task(void *pvParameter){
	...
	while(1){
		...
		/* Wait 2 seconds before reading again - interval of the whole process must be more than 2 sec (from the manufacturer) */
